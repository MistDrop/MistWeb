...
import { MistAddress, MistBlock, MistName, MistTransaction } from "./types";
import * as api from ".";
...
export interface SearchResult {
  ...
  matches: {
    exactAddress: MistAddress | false;
    exactName: MistName | false;
    exactBlock: MistBlock | false;
    exactTransaction: MistTransaction | false;
  };
}
