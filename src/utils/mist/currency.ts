...
import { MistCurrency } from "@api/types";
...
/**
 * Returns whether or not an address is a valid Mist address for the current
 * sync node.
 *
 ...
 *   Note that as of February 2021, the Mist server no longer accepts
...
export function estimateHashRate(work: number, secondsPerBlock: number): string {
  // Identical to the function from MistWeb 1
...
export const useCurrency = (): MistCurrency =>
